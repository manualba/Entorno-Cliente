...
function funcionAjaxAsincronaJSON4(){
    llamadaAsincrona2("servidor/datosCheckbox.php","POST",null,"JSON",tratarResultadoCheck);
}

function tratarResultadoCheck(resultadoB){
    var resultadosB= JSON.parse(resultadoB)
    let salidaB="<table border='1'><tr><th>NOMBRE</th><th>DNI</th><th>FECHA</th><th>HABITACION</th></tr>";
    ...
    document.getElementById("respuestaC").innerHTML=salidaB;
...
function funcionAjaxAsincronaJSON5(){
    llamadaAsincrona2("servidor/datosTextArea.php","POST",null,"JSON",tratarResultadoTA);
}

function tratarResultadoTA(resultadoB){
    var resultadosB= JSON.parse(resultadoB)
    let salidaB="<table border='1'><tr><th>NOMBRE</th><th>DNI</th><th>FECHA</th><th>HABITACION</th></tr>";
    ...
    document.getElementById("respuestaTA").innerHTML=salidaB;
